# IsoGraph Experiment 006 — Cold Integrated Qualification Prompt R2
...
- DP 0.2 — Discovery Protocols correction layer over DP 0.1.
...
Use the supplied specifications exactly as written. For Discovery Protocols, apply DP 0.1 together with the DP 0.2 correction layer; where DP 0.2 strengthens or replaces DP 0.1 behavior, DP 0.2 governs.
...
8. A residual difference in representation, factorization, proof method, carrier, or implementation is not by itself a natural distinction.
9. When DP 0.2 triggers cross-residual decomposition or an NEI distinction audit, follow those rules without treating UNKNOWN/incomplete identity authority as SAME or DISTINCT.
10. For the proof benchmark, use only the mathematical structure supplied in Proof Alpha and Proof Beta. Do not name the theorem, proof traditions, authors, or external literature even if you recognize them.
...
Do not assume they are isomorphic and do not assume they are unrelated. Apply DP 0.1 as corrected by DP 0.2 adaptively to find the strongest defensible common proof structure.
...
9. Apply the DP 0.2 cross-residual decomposition gate before treating different mathematical machinery as terminal divergence.
10. Where a same-role distinction is substantially representational and would otherwise terminate the search, apply the DP 0.2 NEI distinction-audit routing. Do not infer SAME merely from structural correspondence.
11. Stop only under the stopping conditions permitted by the supplied Discovery Protocol authority.
